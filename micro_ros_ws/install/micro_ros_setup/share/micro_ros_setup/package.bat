...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\micro_ros_setup\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/micro_ros_setup/local_setup.bat"
