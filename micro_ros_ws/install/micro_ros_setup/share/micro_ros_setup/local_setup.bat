...
set "AMENT_ENVIRONMENT_HOOKS[micro_ros_setup]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[micro_ros_setup] "%AMENT_CURRENT_PREFIX%\share\micro_ros_setup\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[micro_ros_setup] "%AMENT_CURRENT_PREFIX%\share\micro_ros_setup\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[micro_ros_setup]:;=";"%") do (
    call:call_file %%f
  )
